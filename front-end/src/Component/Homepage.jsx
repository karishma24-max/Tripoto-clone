...
function Homepage() {
  return (
    ...
    <VStack
      ...
      <Stack maxW={'2xl'} align={'flex-start'} spacing={6}>
        ...
        <Stack spacing={4}>
        <InputGroup backgroundColor={'white'} width={{lg:'550px' ,md:"300px",sm:"250px"}}>
  ...
  <Flex alignItems={'flex-start'} marginLeft='120px' p={2}>
    <Text  fontSize='xs' color={'gray.500'}>SPONSORED</Text>
  </Flex>
    <Flex alignItems={'center'} flexDir={"column"}>
    <Image width={"1000px"} src='https://tpc.googlesyndication.com/simgad/968686610659141041' alt='img1' />
    </Flex>
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} alignItems={'center'} flexDir='row' gap='2' margin={"75px"}>
    <Image width={'280px'} height={"70px"} src='https://cdn1.tripoto.com/media/filter/tst/img/311219/Image/1657192329_aa.png' alt='img1' />
    <Image width={'280px'} height={"70px"} src='https://cdn1.tripoto.com/media/filter/tst/img/311219/Image/1657192307_cc.png' alt='img1' />
    <Image width={'280px'} height={"70px"} src='https://cdn1.tripoto.com/media/filter/tst/img/311219/Image/1657192273_bb.png' alt='img1' />
    <Image width={'280px'} height={"70px"} src='https://cdn1.tripoto.com/media/filter/tst/img/311219/Image/1657192344_dd.png' alt='img1' />
    </Flex>
    
    
    <Text marginLeft="75px" marginTop='-20px' marginBottom={'10px'} fontSize={useBreakpointValue({ base: '2xl', md: '3xl' ,sm:"xl"})} fontWeight={'bold'}>
    In the Spotlight: Partnerships
    </Text>
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"250px"} gap={3} flexDir="column">
    ...
    <Image width={"1130px"} height={'350px'} borderRadius="7px" src='https://cdn1.tripoto.com/media/filter/tst/img/2224454/Image/1670822273_mobile.jpg' alt='img1' />
    </Flex>

    <Text marginLeft="75px" marginBottom={'10px'} fontSize={useBreakpointValue({ base: '2xl', md: '3xl' ,sm:"xl"})} fontWeight={'bold'}>
    Find Best Places to Visit in India in December & January
    </Text>
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} height="164px" src='https://cdn1.tripoto.com/media/filter/tst/img/2215463/Image/1666949651_1636600759_110.png' alt='img2' />
      ...
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} height="164px" src='https://static2.tripoto.com/media/filter/tst/img/192200/TripDocument/1571216585_adrithcollage.jpg' alt='img2' />
    ...
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} marginTop="20px" alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"250px"} gap={3} flexDir="column">
    ...
    <Flex alignItems={'center'} flexDir={"column"} p={10}>
    <Image width={"1130px"} height={'350px'} borderRadius="7px" src='https://cdn1.tripoto.com/media/filter/nxxl/img/2215463/Image/1669366871_kerala.jpg' alt='img1' />
    </Flex>
    
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} marginTop="20px" alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} height={'165px'} src='https://cdn1.tripoto.com/media/filter/tst/img/2215463/Image/1669368402_1656747258_dream_holidays_c8mz8fp_zvc_unsplash.jpg' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>Nagaland's Hornbill Festival Is Happening This December</Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} height="164px" src='https://cdn1.tripoto.com/media/filter/tst/img/2215463/Image/1669368370_1650865492_nature_photographer_29ezcwtmtnm_unsplash.jpg' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>26 Best Places In India To Visit This December</Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} height="164px" src='https://cdn1.tripoto.com/media/filter/tst/img/2215463/Image/1669368422_1650645286.jpeg' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>10 Events You Can't Miss This Winter In Delhi</Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} src='https://cdn1.tripoto.com/media/filter/tst/img/2215463/Image/1669368429_1669359075_screenshot_2022_11_25_at_12_18_09_pm.png' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>10 Recommended Destinations For Solo Travelers</Text>
      </Flex>
    </Flex>
    ...
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} marginTop="20px" alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"350px"} gap={3} flexDir="column">
    ...
    <Text marginLeft="75px" marginTop={'30px'} marginBottom={'10px'} fontSize={useBreakpointValue({ base: '2xl', md: '3xl' ,sm:"xl"})} fontWeight={'bold'}>
    ...
    <Flex alignItems={'center'} flexDir={"column"} p={10}>
    <Image width={"1130px"} height={'300px'} borderRadius="7px" src='https://cdn1.tripoto.com/media/filter/nxxl/img/2215463/Image/1669615247_maldives.jpg' alt='img1' />
    </Flex>
    ...
    <Text marginLeft="75px" marginTop={'30px'} marginBottom={'5px'} fontSize={useBreakpointValue({ base: '2xl', md: '3xl' ,sm:"xl"})} fontWeight={'bold'}>
    In the Spotlight: Tripoto Creators of the Month - November 2022
    </Text>
    <Text fontSize={'sm'} marginLeft="75px">
    ...
    <Flex display={{lg:"flex", md: 'box',sm:'box' }} marginTop="20px" alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"200px"} gap={3} flexDir="column">
    ...
    <Flex marginBottom={'30px'} display={{lg:"flex", md: 'box',sm:'box' }} alignItems={'center'} flexDir='row' gap='8' marginLeft={'75px'}>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} height="164px" src='https://image.mux.com/65Mxwlku9ue7VTvDW8F72z1U5VIOiEaz/thumbnail.jpg?width=600&height=600&time=2.0' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>10 Best Places To Experience The Chills This Winter</Text>
        <Text fontSize="sm">By  <Link color={'teal'}> Namita Mittal</Link></Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} height="164px" src='https://cdn1.tripoto.com/media/filter/tst/gen/1789711/Image/1634027797_thumbnail.jpg' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>15 Winter Destinations, That Are Not Shimla Or Manali</Text>
        <Text  fontSize="sm">By  <Link color={'teal'}> Namita Mittal</Link></Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} height="164px" src='https://image.mux.com/iFVXAVPcgtz02Zcmt2ExiBVFZbYw7iMhN/thumbnail.jpg?width=600&height=600&time=3.01' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>Trips To Take With Your Bae This Winter In India</Text>
        <Text  fontSize="sm">By  <Link color={'teal'}> Namita Mittal</Link></Text>
      </Flex>
      <Flex width={"250px"} gap={3} flexDir="column">
        <Image borderRadius={"7px"} width={"250px"} height="164px" src='https://image.mux.com/VZNhkabs2mLwRfjO6j600Q7OmfLxm5VmV/thumbnail.jpg?width=600&height=600&time=2.0' alt='img2' />
        <Text fontSize="md" fontWeight={"bold"}>12 Hot Springs In India That Will Warm You Up This Winter</Text>
        <Text fontSize="sm">By  <Link color={'teal'}> Namita Mittal</Link></Text>
      </Flex>
    </Flex>
